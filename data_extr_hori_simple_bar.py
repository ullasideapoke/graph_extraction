...
def data_ext_hori_simple(image_croping_res):
    ...
    if len(data_points) > 1:
        print("\n[INFO] SIMPLE VERTICAL BAR GRAPH WITH VALUES")
        final_df = data_extraction_simple_bar_approach_1(image_croping_res)
        
    else:
        print("\n[INFO] SIMPLE VERTICAL BAR GRAPH WITH NO VALUES")
...
#     path = "/home/ideapoke/Desktop/Work/yolo_implementation/Horizonta_graph/simple_horizontal/Chart_classification_model_horizontal/images/simple_graph_no_val.jpg"
...
#     if len(data_points) > 1:
#         print("SIMPLE BAR GRAPH WITH VALUES")
#         s_time = time.time()
#         data_extraction_simple_bar_approach_1(image_croping_res)
#         print(data_extraction_simple_bar_approach_1(image_croping_res))
#     else:
#     	print("SIMPLE BAR GRAPH WITH NO VALUES")
#     	s_time = time.time()
#     	data_extraction_simple_bar_approach_2(image_croping_res)
#     	print(data_extraction_simple_bar_approach_2(image_croping_res))
